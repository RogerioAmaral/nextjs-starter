        ...
        <LayoutBase
                        ...
                        <main className="h-full">
                            ...
                            <PageContainerBody pageContainerType={'contained'}>
                                {pageBackgroundType === 'plain' ? (
                                    <div
                                        className={classNames('bg-white dark:bg-gray-900 rounded-2xl', pageContainerGutterClass)}>
                                        {children}
                                    </div>
                                ) : (
                                    children
            ...
            <div className="flex flex-auto min-w-0">
                <div className="flex flex-col flex-auto min-h-screen min-w-0 relative w-full">
                    <Header
                        container
                        className={classNames('fixed', isSticky
                    ...
                    <div
                        className="h-[400px] bg-[linear-gradient(220deg,_rgb(9,_12,_17)_10%,_#15122f_35%,_#2b1e38_55%,_#0c2239_70%,_rgb(9,_12,_17)_90%)]">
