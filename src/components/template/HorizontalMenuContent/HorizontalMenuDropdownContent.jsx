...
const ColumnsLayout = (
    ...
    return (
        <div className="flex max-w-[1400px] w-full">
            <div
                className={classNames('grid gap-y-6 gap-x-8 p-6 flex-1', gridClasses[columns]?.grid)}>
                                        ...
                                        <AuthorityCheck
                                            ...
                                            <div key={subNav.key}>
                                                <MenuLink
                                                    ...
                                                    description={t(subNav.meta?.description
                                                        ?.translateKey ||
                            ...
                            return (
                                <AuthorityCheck key={nav.key} userAuthority={userAuthority} authority={nav.authority}>
                                    <MenuLink
                                        ...
                                        description={t(nav.meta?.description
                                            ?.translateKey || '', nav.meta?.description?.label || '')}
...
const TabLayout = ({
    ...
    const [activeKey, setActiveKey] = useState(navigationTree.some((nav) => nav.key === routeParentKey)
        ? routeParentKey
    ...
    return (
        <div className="flex">
            ...
            {navigationTree.some((nav) =>
                nav.key === activeKey &&
                nav.type === NAV_ITEM_TYPE_COLLAPSE) && (
                <div
                    className="ltr:border-l rtl:border-r border-gray-200 dark:border-gray-800 p-6">
                    <div
                        className={classNames(
                            'grid gap-x-8 flex-1',
