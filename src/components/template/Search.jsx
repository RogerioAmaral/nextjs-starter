            ...
            <div
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="text-gray-900 dark:text-gray-300">
                        <Highlighter
                            autoEscape
                            highlightClassName={classNames('text-primary', 'underline bg-transparent font-semibold dark:text-white')}
                            searchWords={[keyWord]}
...
const _Search = ({
    ...
    return <>
        ...
        <Dialog
            ...
            <div>
                <div
                    className="px-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-600">
