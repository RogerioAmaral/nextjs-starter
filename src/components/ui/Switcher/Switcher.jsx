...
const Switcher = (props) => {
    ...
    return (
        <label
            ref={labelRef}
            className={classNames('switcher', (switcherChecked || controlProps.checked) &&
                `switcher-checked ${switcherColor}`, disabled && 'switcher-disabled', className)}>
            <input
                ref={ref}
                type="checkbox"
                disabled={disabled}
            ...
            {isLoading ? (
                <Spinner
                    className={classNames('switcher-toggle-loading', switcherChecked
