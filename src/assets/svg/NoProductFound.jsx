const NoProductFound = ({
    ...
    return (
        <svg
            ...
            <path
                d="M342.2 209.3c-.1 0-.2 0-.3-.1l-59.3-25.9c-.3-.1-.5-.5-.4-.8l7.4-27.6c.5-1.8 1.7-3.3 3.4-4.1 1.7-.8 3.6-.8 5.3-.1l56.9 24.8c1.7.7 3 2.2 3.5 3.9.5 1.8.3 3.7-.7 5.2L342.8 209c-.1.2-.3.3-.6.3zm-58.4-27 58.2 25.4 14.9-23.6c.8-1.2 1-2.7.5-4-.4-1.4-1.4-2.5-2.7-3l-56.9-24.8c-1.3-.6-2.8-.5-4.1.1-1.3.6-2.2 1.8-2.6 3.1l-7.3 26.8z" />
            <path
                d="M318.1 183c3 1.3 4.3 4.7 3 7.7l-31.7 72.6c-1.3 3-4.7 4.3-7.7 3-3-1.3-4.3-4.7-3-7.7l31.7-72.6c1.3-2.9 4.8-4.3 7.7-3z"
                className="fill-primary" />
            <path
                d="M284 267.5c-.9 0-1.8-.2-2.6-.6-3.3-1.4-4.8-5.3-3.4-8.6l31.7-72.6c.7-1.6 2-2.8 3.6-3.5 1.6-.6 3.4-.6 5 .1s2.8 2 3.5 3.6c.6 1.6.6 3.4-.1 5L290 263.5c-.7 1.6-2 2.8-3.6 3.5-.7.4-1.5.5-2.4.5zm31.8-84.3c-.6 0-1.3.1-1.9.4-1.3.5-2.3 1.5-2.8 2.7l-31.7 72.6c-1.1 2.6.1 5.6 2.6 6.7 2.6 1.1 5.6-.1 6.7-2.6l31.7-72.6c.5-1.3.6-2.6.1-3.9-.5-1.3-1.5-2.3-2.7-2.8-.6-.3-1.3-.5-2-.5z" />
            <path
                d="M273.1 365.8c1-1 2.1-2 3.2-3.1-16.8-16.5-37.3-25.3-61.5-26.5-.5 11.7.1 21.2 2.1 29.6h56.2z"
                className="fill-primary" />
            <path
                d="M273.1 366.5h-56.2c-.3 0-.6-.2-.7-.6-2-8.3-2.7-17.8-2.1-29.8 0-.2.1-.4.2-.5.1-.1.3-.2.5-.2 12.1.6 23.5 3.2 33.8 7.6 10.3 4.4 19.8 10.9 28.2 19.1.1.1.2.3.2.5s-.1.4-.2.5c-1.1 1.1-2.1 2.1-3.2 3.1-.2.2-.3.3-.5.3zm-55.6-1.5h55.3l2.4-2.4c-8.2-7.9-17.3-14.1-27.2-18.3-9.9-4.3-20.9-6.8-32.5-7.4-.5 11.3.2 20.2 2 28.1z" />
            <path
